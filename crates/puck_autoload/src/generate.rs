...
const CLASSMAP_INSTALLED_VERSIONS: &str = r#"<?php
...
fn classmap_file() -> &'static str {
    // Composer always classmaps InstalledVersions even without -o.
    CLASSMAP_INSTALLED_VERSIONS
}
...
"#
    ...
    // Always include InstalledVersions (Composer does this without -o).
    out.push_str(
